...
/*
  ...
  - Affiche la liste des utilisateurs et permet de modifier leur rôle et leurs droits d'accès aux outils.
  - Permet la suppression d'utilisateurs (sauf l'utilisateur courant).
  - Permet l'export CSV de la liste des utilisateurs.
  - Affiche des paramètres globaux et des logs d'activité simulés.
*/
...
export function AdminPanel({
  ...
  // Nom de l'entreprise (paramètre global)
